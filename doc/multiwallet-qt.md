...
In order to support loading of multiple wallets in Hello-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Hello.cpp.
...
Changes to Hello.cpp
----------------------
Hello.cpp is the entry point into Hello-qt, and as such, will require some minor modifications to provide hooks for
