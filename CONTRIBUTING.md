Contributing to hello Core
============================

The hello Core project operates an open contributor model where anyone is
...
The following applies to code changes to the hello Core project, and is not to be
confused with overall hello Network Protocol consensus changes.

Whether a pull request is merged into hello Core rests with the project merge
...
Patches that change hello consensus rules are considerably more involved than
...
Where a patch set proposes to change the hello consensus, it must have been
...
The project leader is the release manager for each hello Core release.
