...
/** Utility functions used by the hello Qt UI.
 */
namespace GUIUtil
{
...
// Render hello addresses in monospace font
...
// Parse "hello:" URI into recipient object, return true on successful parsing
