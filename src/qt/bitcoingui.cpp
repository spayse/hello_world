                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("hello Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a hello address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hello: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSIRAJ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About hello Core"), this);
    aboutAction->setStatusTip(tr("Show information about hello Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for hello"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your hello addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified hello addresses"));
    ...
    openAction->setStatusTip(tr("Open a hello: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the hello Core help message to get a list with possible hello command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("hello Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to hello network", "", count));
}
...
{
    QString strTitle = tr("hello Core"); // default title
