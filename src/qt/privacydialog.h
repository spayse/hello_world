...
public:
    ...
    void setZSIRAJControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSIRAJ_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSIRAJ_clicked();
    void on_pushButtonZSIRAJControl_clicked();
