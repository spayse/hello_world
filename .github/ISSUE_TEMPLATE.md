...
This issue tracker is only for technical issues related to Hello Core.
General Hello questions and/or support requests and are best directed to the [Hello Slack](http://Hello.slack.com).
...
### What version of Hello Core are you using?
