                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SIRAJ from zSIRAJ"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSIRAJ"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSIRAJ));
